"""This module has two functions identifier_group and print_identifier group.

identifier_group behaves similarly to dir but can be used to return a list of strings of identifiers by the parameter kind.
print_identifier_group prints instead of returning a list.
"""
