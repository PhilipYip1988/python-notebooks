...
The counts can be assigned to values which matched the original weights, recall that these should be considered as a physical counts. A sample of k=25 can be taken and k=117 (all values) can be taken. 
